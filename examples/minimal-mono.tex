% !TeX program = xelatex
% 与 claritycv.tex 共用内容结构和基础尺寸，仅通过公开参数切换为黑灰极简风格；全部信息均为虚构。
...
\resumeheader[
  ...
  \resumecontact{\faGlobe}{技术博客：\href{https://example.com/lin-ai-lab}{\nolinkurl{https://example.com/lin-ai-lab}} \textcolor{ExampleMono}{\textbf{（28万+访问量）}}}
  \\
  \resumecontact{\faGithub}{代码主页：\href{https://example.com/lin-zhiyuan-code}{\nolinkurl{https://example.com/lin-zhiyuan-code}}}\\
  \resumecontact{\faGithub}{项目贡献：\href{https://example.com/chronos-lab}{ChronosLab}\textcolor{ExampleMono}{(\faStar\hspace{0.25em}\textbf{4.8k stars})}、\href{https://example.com/opti-grid}{OptiGrid} \textcolor{ExampleMono}{(\faStar\hspace{0.25em}\textbf{36.2k stars})}}
}
...
\begin{itemize}
  ...
  \item \textbf{主要工作：}
    \begin{enumerate}
      ...
      \item \textbf{调度优化：}建立容量、峰谷电价和设备启停约束，将示例园区综合调度成本降低 \textcolor{black}{\textbf{12.4\%}}。
    \end{enumerate}
\end{itemize}
...
\section{学科竞赛}
\begin{multicols}{2}
\begin{itemize}[label={\color{ExampleMono}\faTrophy}]
